...
// input = 10 20 30 word bananas space field alt 2 45 fields alt 2 45 fields alt 2

rl.question(
  "Hello. Enter words or digits, that you want to sort, dividing them with spaces: ",
  (userInput) => {
